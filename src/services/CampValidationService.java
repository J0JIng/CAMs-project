...
public class CampValidationService implements ICampValidationService {
	...
	public boolean dateClashExists(Camp camp1, Camp camp2) {
		LocalDate camp1StartDate = camp1.getCampInformation().getCampStartDate();
		LocalDate camp1EndDate = camp1.getCampInformation().getCampEndDate();
		LocalDate camp2StartDate = camp2.getCampInformation().getCampStartDate();
		LocalDate camp2EndDate = camp2.getCampInformation().getCampEndDate();
		...
		return (camp1EndDate.equals(camp2StartDate) || camp1EndDate.isAfter(camp2StartDate)) ||
		(camp1StartDate.equals(camp2EndDate) || camp1StartDate.isBefore(camp2EndDate));
	}
	 ...
	 */
    @Override
	public boolean isCampOver(LocalDate currentDate, Camp camp) {
		return currentDate.isAfter(camp.getCampInformation().getCampRegistrationClosingDate());
	}
