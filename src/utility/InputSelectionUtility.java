...
>>>>>>> eefd642a51ec84d47395937eac077761227004ce
     ...
     */
    public static LocalDate getDateInput(String prompt, DateTimeFormatter dateFormat) {
        LocalDate date = null;
...
<<<<<<< HEAD
    ...
    public static CampInformation getCampInput(List<Camp> allCamps, Staff staff, DateTimeFormatter dateFormat) {
        ...
        do {
            ...
            if (campStartDate.isBefore(campRegistrationClosingDate)) {
                System.out.println("Camp start date must be after the registration closing date. Please enter a valid date.");
            }
        } while (campStartDate.isBefore(campRegistrationClosingDate));
        ...
        } while (campEndDate.isBefore(campStartDate));
...
>>>>>>> eefd642a51ec84d47395937eac077761227004ce
     ...
     */
    public static boolean updateCampInput(Camp camp, Staff staff , DateTimeFormatter dateFormat) {
...
<<<<<<< HEAD
                ...
                case 2:
                    ...
                    LocalDate newStartDate = getDateInput("Enter new camp start date (dd/MM/yyyy): ", dateFormat);
...
<<<<<<< HEAD
                    LocalDate newEndDate = getDateInput("Enter new camp end date (dd/MM/yyyy): ", dateFormat);
...
<<<<<<< HEAD
                    LocalDate newRegistrationClosingDate = getDateInput("Enter new camp registration closing date (dd/MM/yyyy): ", dateFormat);
